...
nombre = input()
print("Introduce el número de horas trabajadas:")
...
if salario_bruto <= 500:
    ...
    tasa_impuestos = (salario_bruto - 500) * 0.25
else:
    tasa_impuestos = (400 * 0.25) + ((salario_bruto - 900) * 0.45)
salario_neto = salario_bruto - tasa_impuestos
print("Nombre del trabajador:", nombre)
print("Salario bruto: {:.2f}€".format(salario_bruto))
print("Tasas de impuestos: {:.2f}€".format(tasa_impuestos))
